...
function onepixplugin_strip_html_the_content() {
    ob_start();
    the_content();
...
//filter content
function onepixplugin_filter_content($content) {
...
function onepixplugin_shorten($string, $length)
{
...
//remove http://
function onepixplugin_strip_http ($input) {
