...
function onepix_create_settings_field( $args = array() ) {  
    ...
    add_settings_field(
            ...
            __FILE__,                 // The page on which this option will be displayed
...
<!--    setup topmost tabs - (wordpress privides css for "nav-tab-wrapper" and "nav-tab")-->
        <h2 class="nav-tab-wrapper">
            <a href="?page=onepix-settings&tab=general_settings" class="nav-tab <?php echo $active_tab == 'general_settings' ? 'nav-tab-active' : ''; ?>">Settings</a>
            <a href="?page=onepix-settings&tab=more_information" class="nav-tab <?php echo $active_tab == 'more_information' ? 'nav-tab-active' : ''; ?>">More Information</a>
        </h2>
...
<!--                jqueyry tabs setup in theme-settings.js (setup different than the topmost tabs)-->
                <div id="tabs" class="onepix-settings-tabs ">
                    <div class="settings-tabs">
                        <ul>
                            <!--note that the anchor href must match the text with -settings on the end-->
                            <li><a href="#general-settings">General</a></li>
                            <li><a href="#typography-settings">Typography</a></li>
                            <li><a href="#color-&-background-settings">Color & Background</a></li>
                            <li><a href="#header-settings">Header</a></li>
                            <li><a href="#layout-settings">Layout</a></li>
                            <li><a href="#featured-area-settings">Featured Area Settings</a></li>
							<li><a href="#featured-image-settings">Featured Image Settings</a></li>
                            <li><a href="#featured-slider-settings">Featured Slider Settings</a></li>
                            <li><a href="#social-media-settings">Social Media</a></li>
                            <li><a href="#contact-settings">Contact</a></li>
                        </ul>
                        <p class = "submit">
                            <input name = "Submit" type = "submit" class = "button-primary" value = "<?php esc_attr_e('Save All Settings', 'onepix_textdomain'); ?>" />
                        </p>
                    </div>
                ...
                <?php
            } else if ($active_tab == 'more_information') {
...
function onepix_register_settings(){
    ...
    register_setting($onepix_option_name, $onepix_option_name, 'onepix_validate_options' );  
      
    //sections  
    // add_settings_section( $id, $title, $callback, $page );  
    if(!empty($settings_output['onepix_page_sections'])){  
        // call the "add_settings_section" for each!  
        foreach ( $settings_output['onepix_page_sections'] as $id => $title ) {  
            add_settings_section( $id, $title, 'onepix_section_fn', __FILE__);  
        }  
    }
...
function onepix_validate_options($input) {
