...
createTable('fw_test_output', 'user VARCHAR(30)');


$select_query = "SELECT * FROM fw_input WHERE field='$field'";
queryMysql($select_query );


$query = "INSERT INTO country_code VALUES('$output')";
