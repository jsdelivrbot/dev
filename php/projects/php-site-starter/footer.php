<!--   <div id="footer" class="padding-bottom">
    <footer>
        ...
        <div class="medium-6 columns media-center-med">
            Wigitized Footer
            <div class="copywright margin-top-sml padding-columns">&copy; <a href="#" title="Your Site Brief Tagline">Your Site Title&nbsp;2014 </a>.  Website by <a href="#">Pie CMS</a></div>
        </div>
...
<div id="footer" class="padding-bottom">
    <footer>
        <div class="row footer-text-wrapper">
            <div class="medium-5 columns media-center-med small-text">
                4407 Montrose Rd, Niagara Falls - (905) 358-9898
            </div>
            <div class="medium-7 columns media-center-med small-text">
                <div class="copywright">&copy; 2016 all rights reserved | website designed by <a title="Ben Chung web developer" target="_blank" href="http://www.benchung.com/">Benchung.com</a></div>
            </div>
        </div>
        <!--.container-->
    </footer>
...
<!-- FlexSlider - this (must be put here to use the "defer" attribute in the script tag-->
