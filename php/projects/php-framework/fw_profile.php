...
if (isset($_POST['text']))
{
	...
	$query = "SELECT * FROM fw_profiles WHERE user='$user'";
	if (mysql_num_rows(queryMysql($query)))
	{
		queryMysql("UPDATE fw_profiles SET text='$text' 
				    where user='$user'");
	}
	else
	{
		$query = "INSERT INTO fw_profiles VALUES('$user', '$text')";
		queryMysql($query);
	}
}
else
...
echo <<<_END
<form method='post' action='fw_profile.php'
